        ...
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
            ...
            <div className="relative bg-indigo-900 overflow-hidden">
                <div className="absolute inset-0 opacity-20">
                    <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=2070&auto=format&fit=crop" className="w-full h-full object-cover" alt="Hero Background" />
                </div>
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 flex flex-col items-center text-center">
                    ...
                    <p className="text-lg text-indigo-100 max-w-2xl mb-8">
                        Temukan koleksi fashion terbaru untuk melengkapi penampilanmu sehari-hari dengan kualitas premium.
                    </p>
                    <Link href="#products" className="bg-white text-indigo-900 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition shadow-lg">
                        Belanja Sekarang
                    </Link>
                </div>
            </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
                ...
                <section>
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-2xl font-bold text-gray-900">Kategori Pilihan</h3>
                    </div>
                    <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                        {categories.map((category) => (
                            <Link key={category.id} href="#" className="flex-shrink-0 group">
                ...
                <section id="products">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Link href="#" className="text-indigo-600 font-medium hover:text-indigo-700">Lihat Semua &rarr;</Link>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
                        {products.map((product) => {
                            ...
                            const price = firstVariant ? formatRupiah(firstVariant.price) : 'Stok Habis';
                            ...
                            return (
                                <div key={product.id} className="group bg-white border border-gray-100 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                                    ...
                                    <div className="p-4">
                                        <h4 className="font-semibold text-gray-900 truncate mb-1" title={product.name}>
                                            {product.name}
                                        </h4>
